Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       ...
                       DESC
  s.homepage         = 'https://github.com/marlonconstante/flutter_credential_manager_compose'
  s.license          = { :file => '../LICENSE' }
  s.author           = { 'marlonconstante' => 'marlon.constante@gmail.com' }
  s.source           = { :git => 'https://github.com/marlonconstante/flutter_credential_manager_compose.git', :tag => s.version.to_s }
